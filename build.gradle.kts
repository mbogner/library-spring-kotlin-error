...
dependencies {
    ...
    api(libs.spring.kotlin.reflection)
...
sonarqube {
    properties {
        ...
        property("sonar.projectKey", "library::spring-kotlin-error")
        property("sonar.projectName", "spring-kotlin-error")
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("spring-kotlin-error")
                description.set("API error handling library for Kotlin with Spring Boot.")
                ...
                scm {
                    url.set("https://github.com/mbogner/library-spring-kotlin-error")
                    connection.set("git@github.com:mbogner/library-spring-kotlin-error.git")
                    developerConnection.set("git@github.com:mbogner/library-spring-kotlin-error.git")
                }
                developers {
                    developer {
                        id.set("mbo")
